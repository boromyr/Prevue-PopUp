	...
	((window.Prevue = class {
		...
		restyleEmbeddedSitesScrollbars() {
			...
			(e.innerHTML = `
              ...
              body::-webkit-scrollbar { background: transparent !important; width: 12px !important; height: 6px !important; }
              html::-webkit-scrollbar-track,
              body::-webkit-scrollbar-track { background-color: transparent !important; }
              html::-webkit-scrollbar-thumb,
              body::-webkit-scrollbar-thumb { background: #444 !important; transition: all .2s !important; border-radius: 3px !important; }
