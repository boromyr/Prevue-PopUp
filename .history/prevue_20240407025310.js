(() => {
    ...
    window.Prevue = class {
        ...
        setupTriggers() {
            ...
            // ~  ================================================ Google
            if (window.location.href.includes("google.com/search?") && !window.location.href.includes("tbm=")) {
                let i;
                this.listenTo("mouseover", (e) => {
                    clearTimeout(i);
                    i = setTimeout(() => {
                        const targetElement = e.target;
                        if (targetElement.classList.contains("LC20lb") || targetElement.classList.contains("VNLkW") || targetElement.matches('.VNLkW *')) {
            ...
            // var prevueWrapper = document.getElementById("#prevue--wrapper");
            // prevueWrapper.listenTo("mouseover", function () {
            //     addStyle(`#prevue--wrapper { width: 1100px !important;} .DKV0Md{background-color:red!important;}`);
            // });
            ...
            // // const elementoC = document.querySelector('#prevue--wrapper');
            // const prevueWrapper = document.querySelector('#prevue--wrapper');

            // prevueWrapper.addEventListener('mouseover', function () {
            //     this.addStyle(`#prevue--wrapper { width: 1100px !important;}`);
            // });

            // prevueWrapper.addEventListener('mouseout', function () {
            //     this.addStyle(`#prevue--wrapper { width: 610px !important;}`);
            // });
            // const elementoB = document.querySelector('.DKV0Md');
            ...
            // let cs = document.querySelector('CS_quickMenuIframe');
            let cs = getShadowRoot().getElementById('CS_quickMenuIframe');

            // Funzione per gestire l'evento mouseover
            function handleMouseOver() {
                if (document.querySelector('contextsearch-widgets')) {
                    addStyle('#prevue--wrapper { width: 1059px !important; }');
                } else {
                ...
                const observer = new MutationObserver(function (mutations) {
                    mutations.forEach(function (mutation) {
                        if (mutation.addedNodes && mutation.addedNodes.length > 0) {
                            ...
                            cs = getShadowRoot().getElementById('CS_quickMenuIframe');
                            if (popup || cs) {
                                if (window.location.href.includes("google.com")) {
                                    addStyle('#prevue--wrapper { width: 610px !important; }');
                                } else {
                                    addStyle('#prevue--wrapper { width: 80% !important; }');
                                }
                                addEventsToElement();
                                observer.disconnect();
                            }
