(() => {
    ...
    window.Prevue = class {
        ...
        init() {
            ...
            const elementoA = document.querySelector('.RNNXgb');
            const elementoB = document.querySelector('.DKV0Md');
            // const elementoC = document.querySelector('#prevue--wrapper');

            // Aggiungi un gestore per l'evento mouseover all'elemento A
            elementoA.addEventListener('mouseover', () => {
                elementoB.style.setProperty('background-color', 'red', 'important');
                document.insertRule('#prevue--wrapper { width: 70% !important;}', 0);
                // elementoC.style.setProperty('height', '70%', 'important');
            });

            // Aggiungi un gestore per l'evento mouseout all'elemento A
            elementoA.addEventListener('mouseout', () => {
                document.insertRule('#prevue--wrapper { width: 50% !important;}', 0);
                // elementoC.style.setProperty('height', '50%', 'important');
                elementoB.style.setProperty('background-color', 'initial', 'important');
            });
            // ^ ================================================ END */
