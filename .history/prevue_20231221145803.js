	...
	window.Prevue = class {
		...
		init() {
			...
			if (/^#prevue:sorry/.test(location.hash || "")) {
				alert(
					"Sorry, the previous link doesn't work with Prevue. It tried to redirect you to the opened URL. You were redirected back to the previous page for your convenience.\n\nUnfortunately, there's no way to prevent this from happening."
				);
