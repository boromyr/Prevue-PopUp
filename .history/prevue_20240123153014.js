    ...
    window.Prevue = class {
        ...
        init() {
                    ...
                    document.addEventListener("mouseover", (i) => {
                        document.addEventListener("keydown", (e) => {
                            if ("ArrowUp" === e.key && e.altKey && !e.ctrlKey && !e.shiftKey && !e.metaKey) {
                                this.triggerPreview(i, false, true); //, this.url && e.preventDefault();
                ...
                const handleMouseover = (e) => {
                    if (e.target.closest(".g")) {
                        ...
                        timeoutId = setTimeout(() => {
                            this.triggerPreview(e, false, true);
                        }, 1300);
                    }
                };
            ...
            this.retrieveOptions(options => {
                ...
                this.targetLinks = ['both', 'external'].includes(this.options.targetLinkTypes)
                ...
                if (this.options.keydownTrigger) {
                    this.listenTo('keydown', e => this.triggerPreview(e))
                }
                if (this.options.mousemoveTrigger) {
                    this.listenTo('mousemove', e => this.triggerPreview(e, false, true))
                }
                if (this.options.dragTrigger) {
                    ...
                    this.listenTo('dragend', e => {
                        if (this.dragDelta >= this.options.dragTriggerOpenDelay &&
                            ...
                            this.triggerPreview(e, true, true)
                        }
                    })
                }
        ...
        triggerPreview(e, isDragging = false, recordEvent = false) {
